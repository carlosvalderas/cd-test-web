...
class UsuarioExcepcion extends CActiveRecord
{
	...
	{
		return array(
			'id_usuario_excepcion' => 'ID Excepcion de usuario',
			'f_inicio' => 'Fecha de Inicio',
			'f_fin' => 'Fecha de Termino',
			'excepcion_id_excepcion' => 'Excepción',
	...
	public static function model($className=__CLASS__)
	{
        ...
        public function exp()
        {
            $id=$this->excepcion_id_excepcion;
            $xd=  Excepcion::model()->findByPk($id);
            return $xd->nombre;
        }
}
