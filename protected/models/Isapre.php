...
class Isapre extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('id_isapre, nombre', 'safe', 'on'=>'search'),
		);
	}
	...
	public function relations()
	{
		...
		return array(
			'remuneracions' => array(self::HAS_MANY, 'Remuneracion', 'isapre_id_isapre'),
		);
	}
	...
	public function search()
	{
		...
		$criteria->compare('id_isapre',$this->id_isapre);
